  ...
  <div class="max-w-sm m-auto my-8">
    <div class="border p-10 border-grey-light shadow rounded">
      ...
      <form @submit.prevent="signup">
        ...
        <button type="submit" class="font-sans font-bold px-4 rounded cursor-pointer no-underline bg-green-500 hover:bg-green-500-600 block w-full py-4 items-center justify-center text-white">Sign Up</button>
